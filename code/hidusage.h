...
#define HID_USAGE_GENERIC_MULTIAXIS    ((USAGE) 0x08)
...
#define HID_USAGE_FEATURE_NOTIFICATION                      ((USAGE) 0x47
...
#define HID_USAGE_GENERIC_SYSCTL_DPAD_UP                    ((USAGE) 0x90
#define HID_USAGE_GENERIC_SYSCTL_DPAD_DOWN                  ((USAGE) 0x91
#define HID_USAGE_GENERIC_SYSCTL_DPAD_RIGHT                 ((USAGE) 0x92
#define HID_USAGE_GENERIC_SYSCTL_DPAD_LEFT                  ((USAGE) 0x93
...
#define HID_USAGE_GENERIC_SYSCTL_BREAK                      ((USAGE) 0xA3
#define HID_USAGE_GENERIC_SYSCTL_DEBUGGER_BREAK             ((USAGE) 0xA4
#define HID_USAGE_GENERIC_SYSCTL_APP_BREAK                  ((USAGE) 0xA5
#define HID_USAGE_GENERIC_SYSCTL_APP_DEBUGGER_BREAK         ((USAGE) 0xA6
#define HID_USAGE_GENERIC_SYSCTL_SYSTEM_SPEAKER_MUTE        ((USAGE) 0xA7
#define HID_USAGE_GENERIC_SYSCTL_SYSTEM_HIBERNATE           ((USAGE) 0xA8

#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_INVERT             ((USAGE) 0xB0
#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_INTERNAL           ((USAGE) 0xB1
#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_EXTERNAL           ((USAGE) 0xB2
#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_BOTH               ((USAGE) 0xB3
#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_DUAL               ((USAGE) 0xB4
#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_TOGGLE_INT_EXT     ((USAGE) 0xB5
#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_SWAP               ((USAGE) 0xB6
#define HID_USAGE_GENERIC_SYSCTL_DISPLAY_LCD_AUTOSCALE      ((USAGE) 0xB7
...
#define HID_USAGE_LED_UNDEFINED              ((USAGE) 0x00)
